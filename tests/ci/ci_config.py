...
class CI:
    ...
    JOB_CONFIGS: Dict[str, JobConfig] = {
        ...
        BuildNames.PACKAGE_ARM_TSAN: CommonJobConfigs.BUILD.with_properties(
            build_config=BuildConfig(
                name=BuildNames.PACKAGE_ARM_TSAN,
                compiler="clang-18-aarch64",
                sanitizer="thread",
                package_type="deb",
            ),
        ...
        JobNames.STATEFUL_TEST_ARM_TSAN: CommonJobConfigs.STATEFUL_TEST.with_properties(
            required_builds=[BuildNames.PACKAGE_ARM_TSAN],
            runner_type=Runners.FUNC_TESTER_ARM,
        ),
        ...
        JobNames.STATELESS_TEST_ARM_TSAN: CommonJobConfigs.STATELESS_TEST.with_properties(
            required_builds=[BuildNames.PACKAGE_ARM_TSAN], num_batches=4,
            runner_type=Runners.FUNC_TESTER_ARM,
        ),
